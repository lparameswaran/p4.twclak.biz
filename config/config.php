...
# What is the name of this app?
	define('APP_NAME', 'WordGame');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@twclak.biz'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'lparameswaran@g.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', 'twclakbi_p4_twclak_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
        define('PASSWORD_SALT', 'cscie15$is#a#cool#course%Taught%by%a&great**professor');
        define('TOKEN_SALT', 'Learning((a))lot*of*things--from+this+course');
